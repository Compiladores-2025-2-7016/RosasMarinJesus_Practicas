...
class Lexer(object):
    ...
    def t_IGUAL(self, t):
        r'='
        """
        Regla para reconocer el símbolo igual (=).
        
        Parámetros:
        - t (LexToken): token que contiene el símbolo igual.
        
        Retorna:
        LexToken: token con la clase y lexema IGUAL.
        """
        # Usamos constructor sin lexema
        t.value = ComponenteLexico(ClaseLexica.IGUAL)
        return t
    
    def t_SUMA(self, t):
        r'\+'
        """
        Regla para reconocer el símbolo suma (+).
        
        Parámetros:
        - t (LexToken): token que contiene el símbolo suma.
        
        Retorna:
        LexToken: token con la clase y lexema SUMA.
        """
        # Usamos constructor sin lexema
        t.value = ComponenteLexico(ClaseLexica.SUMA)
        return t
    
    def t_RESTA(self, t):
        r'-'
        """
        Regla para reconocer el símbolo resta (-).
        
        Parámetros:
        - t (LexToken): token que contiene el símbolo resta.
        
        Retorna:
        LexToken: token con la clase y lexema RESTA.
        """
        # Usamos constructor sin lexema
        t.value = ComponenteLexico(ClaseLexica.RESTA)
        return t
    
    def t_MULT(self, t):
        r'\*'
        """
        Regla para reconocer el símbolo multiplicación (*).
        
        Parámetros:
        - t (LexToken): token que contiene el símbolo multiplicación.
        
        Retorna:
        LexToken: token con la clase y lexema MULT.
        """
        # Usamos constructor sin lexema
        t.value = ComponenteLexico(ClaseLexica.MULT)
        return t
    
    def t_DIV(self, t):
        r'/'
        """
        Regla para reconocer el símbolo división (/).
        
        Parámetros:
        - t (LexToken): token que contiene el símbolo división.
        
        Retorna:
        LexToken: token con la clase y lexema DIV.
        """
        # Usamos constructor sin lexema
        t.value = ComponenteLexico(ClaseLexica.DIV)
        return t
